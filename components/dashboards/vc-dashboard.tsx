        ...
        <div className="space-y-6">
            ...
            {hasThesis && (
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <KPICard title="Total Funding" value={formatCurrency(totalFunding)} subtitle={`across ${filtered.length} matches`} icon={<DollarSign className="size-4" />} />
                </div>
            )}
            ...
            <WidgetCard title="Global Deal Flow" subtitle={`${filtered.length} companies`} href="/dashboard/map">
                <MapChart data={filtered} className="h-full min-h-[500px]" />
            </WidgetCard>
